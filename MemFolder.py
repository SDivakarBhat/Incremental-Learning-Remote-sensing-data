...
from vision_dist import VisionDatasetDist
            ...
            for fname in sorted(fnames):
                ...
                if is_valid_file(path):
                    ...
                    with torch.no_grad():
                         ...
                         #del(image)
                    #dist = dist.to('cpu')    
                    item = (path, class_to_idx[target],dist)
                    images.append(item)
    #del(model)
    return images


class DatasetFolderDist(VisionDatasetDist):
    ...
    def __init__(self, root,stream, device, prev, loader, extensions=None, transform=None,
        ...
        super(DatasetFolderDist, self).__init__(root, stream, device, prev, transform=transform,
...
class DistFolder(DatasetFolderDist):
    ...
    def __init__(self, root, stream, device, prev, transform=None, target_transform=None,
        ...
        super(DistFolder, self).__init__(root, stream, device, prev, loader, IMG_EXTENSIONS if is_valid_file is None else None,
                                          transform=transform,
                                          target_transform=target_transform,
