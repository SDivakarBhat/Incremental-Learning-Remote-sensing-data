...
class VGG_16(nn.Module):
    ...
    def __init__(self, in_chan, no_classes = 0,pretrain = True):
        ...
        self.final0.apply(init_weights)
...
if __name__ == "__main__":
    ...
    clss_prob,rep,_,_ = model(rand_data)
